...
exports.prototype = {
  ...
  initialize: function (_options) {
    ...
    this._send = {
        ...
        // Entries removed from head of list{} upon call to POST ?task=send and moved to
        // _pending_responses
        _requests: new dequeue(),
  ...
  send: function (_message, _callback) {
    // Take every message and schedule for delivery. When delivered,
