...
exports.prototype = {
  ...
  initialize: function (_options) {
	...
	this._from = argv.sparrowSmsFromToken || "unknown-from";
  ...
  register_receive_handler: function (_handler) {
    this._express.get('/api/v1/transport/sparrowsms', function(req, res) {
    ...
    this._express.listen(this._sparrowSmsReceivePort);
    return this;
  },
